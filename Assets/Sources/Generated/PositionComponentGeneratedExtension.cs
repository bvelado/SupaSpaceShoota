...
namespace Entitas {
    public partial class Entity {
        ...
        public Entity AddPosition(UnityEngine.Vector2 newCoordinates) {
            var component = CreateComponent<PositionComponent>(ComponentIds.Position);
            component.coordinates = newCoordinates;
            return AddComponent(ComponentIds.Position, component);
        }

        public Entity ReplacePosition(UnityEngine.Vector2 newCoordinates) {
            var component = CreateComponent<PositionComponent>(ComponentIds.Position);
            component.coordinates = newCoordinates;
